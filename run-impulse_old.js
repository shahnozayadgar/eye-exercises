...
const Module = require('./edge-impulse-standalone_old');
const fs = require('fs');
...
// Pipe the parser for reading data
//const parser = port.pipe(new ReadlineParser({ delimiter: '\r\n' }));
// ================== Added: Define Correct Sequence ==================
// Define the correct direction sequence
const correctSequence = ['default', 'left-right', 'up-down', 'circle-right', 'circle-left'];
